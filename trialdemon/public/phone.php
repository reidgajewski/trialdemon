...
<?php
    if (!$_SESSION["email"]) {
        header("Location: ../public/login.php?error=notloggedin");
    }
?>
...
<section>
    <div class="min-h-full flex items-center justify-center pt-12 pb-5 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <h2 class="mt-4 text-center text-3xl font-extrabold text-gray-900">Add a phone</h2>
            <p class="mt-2 text-center text-sm text-gray-600">
                You must add a phone number to use TrialDemon
            </p>
            </div>
            <form id="addPhoneForm" class="mt-8 space-y-6" method="post">
            <input type="hidden" name="remember" value="true">
            <input type="hidden" name="action" value="addPhone">
            <div class="rounded-md shadow-sm -space-y-px">
                <div>
                <label for="phone" class="sr-only">phone</label>
                <input name="phone" type="text" id="phone" required class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-bookmark-purple focus:border-bookmark-purple focus:z-10 sm:text-sm" placeholder="Phone">
                </div>
            </div>
            </form>
            <div>
...
<div class="flex items-center justify-center pt-0 pb-7 px-4 sm:px-6 lg:px-8">
    ...
    <div id="phone_status_div" style="display: none" class="bg-[#FCD7D7] text-red-500 py-2 px-8 mb-2 w-full justify-center rounded-lg">
        <p id="phone_status"></p>
    </div>
    </div>
</div>
...
<script src="./trialdemon/js/phone.js"></script>
