...
<section>
    <div class="min-h-full flex items-center justify-center pt-12 pb-5 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <h2 class="mt-4 text-center text-3xl font-extrabold text-gray-900">Enter the code</h2>
            <p class="mt-2 text-center text-sm text-gray-600">
                Please enter the code that was sent to your phone
            </p>
            </div>
            <form id="confirmCodeForm" class="mt-8 space-y-6" method="post">
            <input type="hidden" name="remember" value="true">
            <input type="hidden" name="action" value="confirmCode">
            <div class="rounded-md shadow-sm -space-y-px">
                <div>
                <label for="otp" class="sr-only">otp</label>
                <input name="otp" type="text" id="otp" required class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-bookmark-purple focus:border-bookmark-purple focus:z-10 sm:text-sm" placeholder="Enter the code here">
                </div>
            </div>
            ...
            <div class="flex items-center justify-center">
                ...
                <p class="text-gray-600">
                    <a id="resendCode" class="text-bookmark-purple cursor-pointer hover:text-bookmark-purple hover:underline underline-offset-4"> resend code </a> or <a href="./phone" class="text-bookmark-purple cursor-pointer hover:text-bookmark-purple hover:underline underline-offset-4"> change phone number </a>
                </p>
                </div>
            </div>
            <div>
                <button name="submit" type="submit" id="confirm" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white hover:text-bookmark-grey bg-bookmark-purple hover:bg-purple-highlight focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-bookmark-purple">
...
<div class="flex items-center justify-center pt-0 pb-7 px-4 sm:px-6 lg:px-8">
    <div id="error" style="display: block" class="text-center text-sm text-error-red font-semibold ">
    <div id="confirm_status_div" style="display: none" class="bg-[#FCD7D7] text-red-500 py-2 px-8 mb-2 w-full justify-center rounded-lg">
...
<script src="./trialdemon/js/entercode.js"></script>
